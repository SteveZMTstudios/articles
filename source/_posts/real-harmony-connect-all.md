...
<img src="https://blog.stevezmt.top/images/blog/real-harmony-connect-all/2_compressed.jpg" width="296" height="640" alt="图片" title="">
...
2. 异地访问设备文件
   ...
   <img src="https://blog.stevezmt.top/images/blog/real-harmony-connect-all/7_compressed.jpg" width="375" height="388" alt="图片" title="">
    - 手机访问电脑的话可能就还得依赖SCP。
1. 远程桌面
...
4. 剪贴板同步
   电脑会自动同步到手机上。手机下拉通知栏，选择发送剪贴板，就可以发送到所有设备
    <img src="https://blog.stevezmt.top/images/blog/real-harmony-connect-all/6_compressed.jpg" width="864" height="1872" alt="图片" title="">
5. 远程锁屏/关机/快捷执行指令
   这个需要Linux & KDE Plasma的kde connect主机，然后在手机上就可以远程执行指令了。
   还可以把快捷方式放到设备管理器（小米设备的在控制中心，叫智能生活）
   <img src="https://blog.stevezmt.top/images/blog/real-harmony-connect-all/1_compressed.jpg" width="296" height="640" alt="图片" title="">
6. 浏览器投放
   手机选择共享网页，在电脑上就可以看到了。
   <img src="https://blog.stevezmt.top/images/blog/real-harmony-connect-all/4_compressed.jpg" width="864" height="1872" alt="图片" title="">
...
8.  类AirDrop
    ...
    手机上共享就找到了。
    <img src="https://blog.stevezmt.top/images/blog/real-harmony-connect-all/5_compressed.jpg" width="864" height="1872" alt="图片" title="">
